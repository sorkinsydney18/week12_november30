...
US_covid %>% 
ggplot(aes(x = US_ideo, y = radical_intention)) +
...
#labels
outcomes <- c("Support BLM Coef", "Protest Rioting Coef", "Protect Property Coef", 
"Confront Police Coef", "Confront BLM Coef", "Destroy Property Coef", "Confront Citizens Coef")
...
ggplot(outcome_tibble,
       aes(factor(x = outcomes, levels = outcomes),
           y = points,
           ymin = lowbounds,
           ymax = upbounds)) +
  geom_pointrange() +
